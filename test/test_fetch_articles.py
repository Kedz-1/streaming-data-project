...
def test_function_returns_message_when_no_articles(monkeypatch, guardian_key, example_search_term):
...
def test_function_returns_up_to_10_articles_when_search_term_present(guardian_key, example_search_term, mock_guardian_response, monkeypatch):
